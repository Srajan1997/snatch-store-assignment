...
var connection = mysql.createConnection({host: 'freedb.tech', user: 'freedbtech_srajanchansoriya',password: 'srajan_chansoriya_1997',database:'freedbtech_snatch'});
...
cloudinary.config({ 
    cloud_name: 'cmpdi', 
    api_key: '513319826388568', 
    api_secret: 'wFYA_jznuhDViSooZTRNJzG1mQw' 
  });
...
//         console.log("uploads/images/"+ req.file.filename.toString() + ext);
//         var file_name="uploads/images/"+ req.file.filename.toString();
//         cloudinary.uploader.upload(file_name, { tags: 'basic_sample' })
//         .then(function (image) {
//           console.log();
...
//           res.json({image_url : image.public_id});
//         })
//         .catch(function (err) {
//           console.log(err);
//           console.log("** File Upload (Promise) FAIL");
